...
// here username and btnText are passed as descructive props , means written inside {} , we can also access them as props.username but when we write props.username we no need to apply destructive props as written inside curly braces 
